'''                          #Game 512 (shortened 2048)
CIS 211 project 2

Design a 4 x 4 grid and move numbered tiles left, right, up, and down using vectors.

Author: Anne Glickenhaus

Credits: N/A

Add tiles with the same multiple of 2 together to
increase to the intended max of the game; 512.
...
class Grid(GameElement):
    ...
    def __init__(self):
        ...
        self.tiles = []
        self._score = 0 # Extra credit scoring
    ...
    def place_tile(self):
        ...
        rand4 = random.random()
        if rand4 <= 0.1:
            tile = Tile(self, row, col, 4) # Extra credit random 4 10% of the time
        else:
